 ...
 */
static uint32_t calculateCRC32(const uint8_t* message, uint32_t nBytes, uint32_t start)
{
...
uint32_t Crc_CalculateCRC32(const uint8_t* Crc_DataPtr, uint32_t Crc_Length, uint32_t Crc_StartValue32, bool Crc_IsFirstCall) {
    ...
    static const uint32_t Crc_32_Tab[]  = { 0x00000000U,0x77073096U,0xEE0E612CU,0x990951BAU,0x076DC419U,0x706AF48FU,0xE963A535U,0x9E6495A3U,
